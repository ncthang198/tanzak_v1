          ...
          <touchable-opacity :on-press="() => goToBookDetail(args.item.id)">
            <view :style="{ width: widthItem, paddingHorizontal: 6, marginTop: 20 }">
              ...
              <view :style="{position: 'absolute', left: 6, top:6, flexDirection: 'row', width: 40, alignItems: 'center', justifyContent: 'center'}">
                <text :style="{color: '#fff', fontSize: 20, fontWeight: 'bold', lineHeight: 20, padding: 0}">{{args.item.index}}</text>
                <text :style="{color: '#fff', fontSize: 10, fontWeight: 'bold', lineHeight: 20, padding: 0}">位</text>
              </view>
              ...
              <view :style="{marginTop: 8}">
                ...
                <view :style="{flexDirection: 'row', marginTop:8, alignItems: 'center' }">
                  <view
                    :style="{flexDirection: 'row', alignItems: 'center', paddingVertical:2, paddingHorizontal:5, backgroundColor: '#155e83', borderRadius: 4  }"
                  >
                  ...
                  <view :style="{flex: 1, flexDirection: 'row-reverse', alignItems: 'center'}">
                    <text :style="{fontSize: 14, color: '#111', marginLeft:0}">{{args.item.page_view_date}}件</text>
                     <image  
                      :source="iconReading"
