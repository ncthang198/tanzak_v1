...
public class AppConstants {
  ...
  public static final String RELEASE_CHANNEL = "staging-2239";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
      ...
      embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@robin_nguyen/proj-tanzaku-app", "assets://shell-app-manifest.json", "application/json"));
      embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40robin_nguyen%2Fproj-tanzaku-app%2F1.0.3%2Fcd79b3a2cdfaac91b9244a10457891ad-37.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
